...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 700) * (bpm / 160) --this is basically speed, idk how to adjust it

    if curStep >= 512 and curStep < 1536 then
        for i = 0,7 do --the amount of notes like 0,7 is all, 0.3 is all opponent and 4,7 is all player. to do single just 0,0
            ...
            setPropertyFromGroup('strumLineNotes', i, 'y', defaultNotePos[i + 1][2] + move * math.cos((currentBeat + i*1) * math.pi))
    ...
    if curStep == 1536 then --this is to revert back to original position
        for i = 0,7 do 
