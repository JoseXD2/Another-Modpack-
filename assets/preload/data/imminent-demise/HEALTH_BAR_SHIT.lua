...
local override_p1_color = override_colors and "00F0FF" or nil
local override_p2_color = override_colors and "1A1A1A" or nil
...
function onCreatePost()
	...
	makeLuaSprite('bendyhealthbar', 'bendyhealthbar', 300, 555);
	addLuaSprite('bendyhealthbar', true)
	setObjectCamera('bendyhealthbar', "hud")	
	setObjectOrder('bendyhealthbar', 2)
	...
	if downscroll then
	setProperty('bendyhealthbar.y', -7)
end	
end
