function onCreate()
	precacheImage('modern-tails')
	precacheImage('modern-tails2')
	makeAnimationList();

	makeAnimatedLuaSprite('bg','console2',-400,-170)addAnimationByPrefix('bg','dance','Background Moving',24,true)
    objectPlayAnimation('bg','dance',false)
    setScrollFactor('bg', 1, 1);
		
	makeAnimatedLuaSprite('tail', 'modern-tails', -501, -70); -- modern-tails
	...
	makeAnimatedLuaSprite('tail2', 'modern-tails2', -501, -70); -- eduardo punches john, cry about it =l
